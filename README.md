...
Docker desktop needs to be installed on the system if aiming for local testing. In order to build the container image simply issues the ofllowing command.
